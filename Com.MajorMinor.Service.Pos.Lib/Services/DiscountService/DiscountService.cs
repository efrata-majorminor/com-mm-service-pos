...
using Com.MM.Service.Pos.Lib.Models.Discount;
...
using MongoDB.Bson;
using HashidsNet;
using Com.MM.Service.Pos.Lib.ViewModels.Discount;
using Com.Danliris.Service.Inventory.Lib.Helpers;
using static Com.MM.Service.Pos.Lib.ViewModels.Discount.DiscountViewModel;
using Com.MM.Service.Pos.Lib.Interfaces;
using Newtonsoft.Json;
using Com.MM.Service.Pos.Lib.ViewModels.NewIntegrationViewModel;
using System.Linq;
using Com.Moonlay.NetCore.Lib;
using Com.MajorMinor.Service.Pos.Lib.ViewModels.Discount;

namespace Com.MM.Service.Pos.Lib.Services.DiscountService
{
