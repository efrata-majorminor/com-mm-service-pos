...
namespace Com.MajorMinor.Service.Pos.Lib.Models.SalesReturn
{
    public class SalesDocReturnDetail : StandardEntity
    {
        ...
        public virtual SalesDocReturn SalesReturn { get; set; }
    }
}
