...
namespace Com.MM.Service.Pos.Lib.Models.SalesDoc
{
    public class SalesDocDetail : StandardEntity
    {
        ...
        public virtual int SalesDocId { get; set; }
        [ForeignKey("SalesDocId")]
        public virtual SalesDoc SalesDoc { get; set; }
