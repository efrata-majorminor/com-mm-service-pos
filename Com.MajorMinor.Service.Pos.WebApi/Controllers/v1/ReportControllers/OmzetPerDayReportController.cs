...
namespace Com.MajorMinor.Service.Pos.WebApi.Controllers.v1.ReportControllers
{
    ...
    public class OmzetPerDayReportController : Controller
    {
        ...
        public OmzetPerDayReportController(IIdentityService identityService, IValidateService validateService, ISalesDocService service)
        {
        ...
        public IActionResult Get(DateTimeOffset dateFrom, DateTimeOffset dateTo, int offset,  int page = 1, int size = 25, string Order = "{}")
        {
            try
            {
                ...
                var data = Service.GetOmzetDayReport(dateFrom, dateTo, offset, page, size, Order);
