...
using Com.MajorMinor.Service.Pos.Lib.Services.SalesDocReturnService;
using Com.MajorMinor.Service.Pos.Lib.Services.SalesDocService;
using Com.MM.Service.Pos.Lib.Interfaces;
using Com.MM.Service.Pos.Lib.Services;
using Com.MM.Service.Pos.Lib.Services.DiscountService;
using Com.MM.Service.Pos.Lib.Services.SalesDocService;
